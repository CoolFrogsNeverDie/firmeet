            ...
            <div class="content-right">
                <table id="dataTable1" style="display: none;">
                    <thead>
                        <tr>
                            <th class="nglist">
                                <p class="ngname" id="voteTitle11"></p>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="nglist">
                                <p class="ngname" id="vote11"></p>
                                <p class="ngname" id="vote22"></p>
                                <p class="ngname" id="vote33"></p>
                                <p class="ngname" id="vote44"></p>
                                <p class="ngname" id="vote55"></p>
                                <p class="ngname" id="totalNum11"></p>
                                <p class="ngname" id="finDate11"></p>
                            </td>
                        </tr>
                    </tbody>
                    <!-- 지도 -->
