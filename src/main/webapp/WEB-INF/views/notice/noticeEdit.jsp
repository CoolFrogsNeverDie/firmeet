      ...
      <div class="diary-area">
        ...
        <div class="content-area">
          <div class="content-left">
            <!-- 여기부터 작성 -->
            <form
              action="${pageContext.request.contextPath }/notice/${clubId}/${memberId}/editwrite"
              method="get"
            >
              <div>
              ...
              <div>
                <label
                  for="firstName"
                  style="font-weight: bold; font-size: 15px; margin-right: 5px"
                  >제목</label
                >
                <input
                  class="noticetitle"
                  ...
                  <div class="modal-body">
                    <form action="" method="post" style="margin-left: 20px">
                      ...
                      <div class="voteleft">
                        ...
                        <button type="button" class="plusbtn">+ 항목추가</button
                        ><br />
                      </div>
