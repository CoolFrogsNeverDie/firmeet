                            ...
                            <div class="modal-body">
                                 ...
                                 <div class="groupschedule">
                                  ...
                                  <div>
                                     ...
                                     <span id="address1"></span><span id="address2"></span>
										...
										<div id="modalWrap">
											<div id="modalContent">
												<div id="modalBody">
    												...
    												<%-- <c:import url="/WEB-INF/views/notice/test.jsp"></c:import> --%>
    												<div class="map_wrap">
														<!-- 지도보여주기 -->
														<div id="map" style="width:100%;height:100%;position:relative;overflow:hidden;display: block;"onclick="relayout()"></div>
														<!-- 지도보여주기 끝 -->
													   	<div id="menu_wrap" class="bg_white">
													        <div class="option">
													            <div>
														            <p><em>검색 후 지도 위에 위치를 클릭해주세요!</em></p> 
														            <div id="clickLatlng"></div>
															        <button type="button" class="btn btn-lg btn-primary" id="searchButton" style="display: none"></button>
													            </div>
													        </div>
													        <hr>
													        <ul id="placesList"></ul>
													    ...
													    <button type="button" class="btn btn-success" id="location" style="margin-left: 10px;">등록하기</button>
													</div>
													...
													$('#searchButton').click(function(event) {
														...
														function searchPlaces() {
														    ...
														    if (!meetPlace.replace(/^\s+|\s+$/g, '')) {
														        alert('키워드를 입력해주세요!');
														        return false;
														    }
														
														    // 장소검색 객체를 통해 키워드로 장소검색을 요청합니다
														    ps.keywordSearch( meetPlace, placesSearchCB); 
														}
...
$(document).ready(function() {
	  $('#popupBtn').click(function() {
		  var searchTerm = $('#meetPlace').val(); // 검색어 가져오기
		  $('#meetPlace').text(searchTerm); // 모달 내 검색 결과 표시
		});
