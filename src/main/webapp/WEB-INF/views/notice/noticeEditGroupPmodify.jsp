				                                 ...
				                                 <div class="grouptitle" id="result"></div>
				                                  <div class="payvotebody">
				                                     ...
				                                     <button type="button" class="btn btn-secondary" id="openmap">지도등록</button>
				                                  	 <input type="hidden" name="address1" value="x" id="address1" value="${vo.address1}"> 
													 <input type="hidden" name="address2" value="y" id="address2" value="${vo.address2}">
				                                     ...
				                                     <input class="groupvotemeet" type="text" id="price" name="price" value="${vo.price}"> 원(인당)<br>
				                                     <span class="groupvotetitle">&nbsp;투표종료 </span>
				                                     <input class="groupvotedate" type="date" id="voteEnd" name="voteEnd" value="${vo.voteEnd}" style="margin-top: 8px; margin-bottom: 8px;"><br>
				                                     <div class="groupminmax">
				                                         <span class="groupvotetitle">최소인원</span>
				                                         <input class="votemin" type="text" id="minPerson" name="minPerson" value="${vo.minPerson}">명
				                                         / <span class="groupvotetitle">&nbsp;&nbsp;&nbsp;최대인원</span>
				                                         <input class="votemin" type="text" id="maxPerson" name="maxPerson" value="${vo.maxPerson}">명
				                                     </div>
				                                 </div>
				                                 <div style="text-align: center; font-weight: bold; margin-top: 20px;">
				                                 	 <button type="button" id="reset" class="ct-color modelbtnR">등록취소</button>
				                                     <button type="button" class="ct-color modelbtnS" id="saveButton2">등록하기</button>
				                                 </div>
				                            </div>
				                        </div>
				                    </div>
