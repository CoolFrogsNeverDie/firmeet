						                              ...
						                              <div id="menu_wrap" class="bg_white">
						                                <div class="option">
						                                    <div>
						                                       ...
						                                       <input type="text" name="address1" value="x" id="x"> 
						                                       <input type="text" name="address2" value="y" id="y">
						                                      <button type="button" class="btn btn-success" id="submitform" style="margin-left: 10px;">확인</button>
