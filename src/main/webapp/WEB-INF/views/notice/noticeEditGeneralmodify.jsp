			...
			<div class="main-content">
				<div class="diary-area" data-memid = "${member.memberId}" data-clubid ="${club.clubId}">
					...
					<div class="diary-body">					
						<!-- 개인별코딩 ---------------------------------------------------------------->
						<form action="${pageContext.request.contextPath}/${clubId }/notice/elmodify" class="formleft" method="get">
							<div class="edittop">
		                        <select name="" id="" class="selectbox">
		                            <option value="notice">공지게시판</option>
		                        </select>
		                        
		                        <input type="radio" name="aboardVal" value="${vo.aboardVal}" id="aboardVal" checked>일반&nbsp;
				                    ...
				                    <div class="modal-dialog">
				                        <div class="modal-content">
				                            ...
				                            <div class="modal-body">
				                                  ...
				                                  <input class="votetitle" type="text" id="voteTitle" name="voteTitle" value="${vo.voteTitle}">
				                                  <div class="voteleft">
				                                      <span class="votespan">1.</span>
				                                      <input class="votetitle" type="date" id="vote1" name="vote1" value="${vo.vote1}"><br>
				                                      <span class="votespan">2.</span>
				                                      <input class="votetitle" type="date" id="vote2" name="vote2" value="${vo.vote2}"><br>
				                                      <span class="votespan">3.</span>
				                                      <input class="votetitle" type="date" id="vote3" name="vote3" value="${vo.vote3}"><br>
				                                      <div class="voteplus">
				                                      </div>
				                                  ...
				                                  <div style="margin-bottom: 30px;">
				                                      ...
				                                      <input class="votemin" type="text" id="totalNum" name="totalNum" value="${vo.totalNum}"><br>
