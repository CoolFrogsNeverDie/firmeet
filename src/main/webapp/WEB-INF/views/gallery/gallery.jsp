            ...
            <div class="content-area">
                ...
                <div class="content-right">
                    <div class="content-bnt">
                        <button onclick="location.href='${pageContext.request.contextPath}/gallery/uploadForm'">사진올리기
                        </button>
                    </div>
                    <div class="gallery-area">
                        <div>
                            ...
                            <a class="example-image-link"
                                href="${pageContext.request.contextPath}/assets/images/testimg/dog1.jpg"
                                data-lightbox="example-set">
                                <img class="example-image"
                                    src="${pageContext.request.contextPath}/assets/images/testimg/dog1.jpg" alt="" />
                            </a>
                            <a class="example-image-link"
                                href="http://lokeshdhakar.com/projects/lightbox2/images/image-3.jpg"
                                data-lightbox="example-set">
