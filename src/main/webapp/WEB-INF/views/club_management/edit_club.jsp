	...
	<div class="container">
    	...
    	<div id="cm_body">
        	<form action="${pageContext.request.contextPath }/club/making" method="post" enctype="multipart/form-data" id = "make-club-form">
          	<div class="row g-3">
            	<div>
                	...
                	<input type="text" class="box" maxlength="5" id = "clubName" value="${club.clubName}" readOnly>
            	</div>
            ...
            <div class="col-sm-12">
                ...
                <input type="text" class="box" id="max" placeholder="" name="max" value="${deInfo.max}" required>명 / 현재 가입인원 :  ${deInfo.preNum}명
            </div>
            ...
            <div class="col-sm-12">
                ...
                <input type="text" class="box box5 TEXT" id="" placeholder="  100자 이내로 작성해 주세요" name="intro1" value="${deInfo.intro1}" required>
                <span style="color:#6b6969; font-size: 13px;" id="counter">(0 / 100)</span>
            </div>
            <div class="col-sm-12, address">
                <label for="firstName">주소</label>
                <select class="form-select w-25 " aria-label="Default select example" id="addressSi" name="address1">
    				<%-- <option value="1" selected="selected">${deInfo.address1}</option> --%>
                </select>
            	<select class="form-select w-25 " aria-label="Default select example" id="addressSiGUnGu" name="address2">
            		<%-- <option value="1" selected="selected">${deInfo.address2}</option> --%>
            	</select>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="box7">
                    ...
                    <input type="text" class="box box8" id="" placeholder="시간" name="detailT" value="${deInfo.detailT}" required>
                    <img src="${pageContext.request.contextPath }/assets/images/icon/place.png" width="30px" height="30px">
                    <input type="text" class="box box8" id="" placeholder="위치" name="detailL" value="${deInfo.detailL}" required>
                <br>
                <img src="${pageContext.request.contextPath }/assets/images/icon/message.png" width="30px" height="30px">
                <input type="text" class="box box8" id="" placeholder="연락처" name="detailP" value="${deInfo.detailP}" required>
                <img src="${pageContext.request.contextPath }/assets/images/icon/vodka.png" width="30px" height="30px">
                <input type="text" class="box box8" id="" placeholder="회식" name="detailE" value="${deInfo.detailE}"  required>
                <br>
                <img src="${pageContext.request.contextPath }/assets/images/icon/cloud.png" width="30px" height="30px">
                <input type="text" class="box box8" id="" placeholder="날씨" name="detailW" value="${deInfo.detailW}" required>
                </div>
            </div>
            ...
            <div class="col-sm-12" >
                ...
                <img id="mainImg" src="${pageContext.request.contextPath }/assets/images/clubimg/${club.img2}" class="imgPre" width="150px" height="150px">
            ...
            <div class="col-sm-12 ">
                ...
                <img id="bgImg" src="${pageContext.request.contextPath }/assets/images/clubimg/${club.img1}"  class="imgPre" width="200px" height="150px">
                <div class="box-file-input box9">
...
<script>
	...
	$(document).ready(function() {
		...
		var result = intro2.replace(/<br>/g, '/\n/g');
		$('#intro2').val(intro2.replace(/<br>/g, '\n'));
	...
	function setAddress(){
		...
		var address1 = '${deInfo.address1}';
		var address2 = '${deInfo.address2}';
		$('#addressSi').val(address1).prop("selected", true);
		$('#addressSiGUnGu').val(address2).prop("selected", true);
	...
	var areaSelectMarker = function(target){
		...
		for(i=0; i<$(target).length; i++){
		    (function(z){
		        ...
		        //권역 생성  (로딩될때 시도 그리기)---------------------------------------------
		        var addressSi = "${deInfo.address1}";
		        var area1 = Object.keys(area);
		        
		        area1.forEach(function(siDo){
		        	if(siDo == addressSi){
		        		a1.append("<option value="+siDo+" selected='selected'>"+siDo+"</option>");	
		        	}else {
		        ...
		        /* 로딩될때 시군구 그리기 */
		        var address2 = "${deInfo.address2}";  /* 시군구 */
		        console.log("시도:",  addressSi)
		        var siGunGoArray = Object.keys(area[addressSi]);
		        console.log(siGunGoArray);
		       
		        siGunGoArray.forEach(function(siGunGo){
		        	if(address2==area[addressSi][siGunGo]){
		        		a2.append("<option value="+area[addressSi][siGunGo]+" selected='selected'>"+area[addressSi][siGunGo]+"</option>");	
		        	}else {
		        		a2.append("<option value="+area[addressSi][siGunGo]+">"+area[addressSi][siGunGo]+"</option>");
		        	}
		        });
