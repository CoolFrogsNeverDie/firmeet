				        ...
				        <div id="select_field">
				            ...
				            <ul>
				                 <c:forEach  items="${cateList}" var="cate" >
				                 	<li>
				                 		<input type="radio" name="cateNo"  value="${cate.cateNo}" id="${cate.cateNo}" >
				                 		<label for="${cate.cateNo}">${cate.category}</label>
				                 	</li>
				                 </c:forEach>
				            </ul>
				        </div>
        ...
        <c:forEach items="${requestScope.pMap.clubList}" var="clubs" >
            <li>
                <a href="${pageContext.request.contextPath}/club/joinForm2/${clubs.clubId}">
                    ...
                    <p class="meetTitle">${clubs.clubName}</p>
                    <p class="meetContent">${clubs.intro1}</p>
                </a>
            </li>
        </c:forEach> 
        </ul>
