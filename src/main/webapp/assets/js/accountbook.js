...
function drawImg() {
	...
	for (var i = 0; i < rowLng; i++) {
		...
		var index = (i % imageData.length); // Use modulus operator to loop through imageData
		cellhide.innerHTML = '<img src="' + imageData[index].src + '" class="' + imageData[index].class + '" width="' + imageData[index].width + '" height="' + imageData[index].height + '" alt="' + imageData[index].alt + '">';
